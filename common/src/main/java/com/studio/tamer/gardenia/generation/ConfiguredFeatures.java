...
public class ConfiguredFeatures {
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> DOOM_POPPY_KEY = registerKey("doom_poppy");
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> DREAM_ROSE_KEY = registerKey("dream_rose");
    ...
    public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> context) {
        ...
        FeatureUtils.register(context, DOOM_POPPY_KEY, Feature.SIMPLE_RANDOM_SELECTOR, getSingleFlowerConfiguration(ModdedBlocks.DOOM_POPPY));
        ...
        FeatureUtils.register(context, RED_ROSE_KEY, Feature.FLOWER, getFlowerConfiguration(64, 6, 2, ModdedBlocks.RED_ROSE));
        FeatureUtils.register(context, DREAM_ROSE_KEY, Feature.FLOWER, getFlowerConfiguration(32, 6, 2, ModdedBlocks.DREAM_ROSE));
    ...
    private static SimpleRandomFeatureConfiguration getSingleFlowerConfiguration(Block block) {
        return new SimpleRandomFeatureConfiguration(HolderSet.direct(PlacementUtils.onlyWhenEmpty(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(block)))));
    }
